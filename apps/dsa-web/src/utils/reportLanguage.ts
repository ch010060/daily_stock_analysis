...
const REPORT_TEXT = {
  zh: {
    ...
    copyPlainText: '複製純文字',
    copyTwDailyMarkdown: '複製台股日報（Markdown）',
    copyTwDailyPlainText: '複製台股日報（純文字）',
    downloadPdf: '下載 PDF',
    analysisModel: '分析模型',
    systemScore: '系統評分',
  ...
  en: {
    ...
    copyTwDailyMarkdown: 'Copy Taiwan Daily Report (Markdown)',
    copyTwDailyPlainText: 'Copy Taiwan Daily Report (Plain Text)',

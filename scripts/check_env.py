...
使用方法：
    ...
    python scripts/check_env.py --db         # 僅檢視資料庫
    python scripts/check_env.py --llm        # 僅測試 LLM
    python scripts/check_env.py --fetch      # 僅測試資料獲取
    python scripts/check_env.py --notify     # 僅測試通知

...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "STOCK_LIST": {
        ...
        "is_required": False,
        "is_editable": True,
        "default_value": "2330,2454,AAPL,NVDA",
        "options": [],
        ...
        "docs": [
            {
                "label": "完整指南：環境變數完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#環境變數完整列表",
            },
            {
    ...
    "LLM_CHANNELS": {
        ...
        "docs": [
            {
                "label": "LLM 配置指南：通道模式",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/LLM_CONFIG_GUIDE.md#方式二通道channels模式配置適合進階多模型",
            },
            {
                "label": "LLM 服務商配置速查",
    ...
    "STOCK_INDEX_REMOTE_UPDATE_ENABLED": {
        ...
        "description": "Opt-in refresh for the local TW/US stock autocomplete index from the built-in GitHub source. The default runtime path uses the bundled local TW/US snapshot.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "FINMIND_ENABLED": {
        ...
        "docs": [
            {
                "label": "完整指南：資料來源配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#資料來源配置",
            },
        ],
    ...
    "ANSPIRE_API_KEYS": {
        ...
        "docs": [
            {
                "label": "完整指南：搜尋服務配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜尋服務配置",
            },
        ],
    ...
    "ANTHROPIC_MAX_TOKENS": {
        ...
        "description": "Anthropic API 響應最大 token 數（預設 8192）。",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "WECHAT_WEBHOOK_URL": {
        ...
        "docs": [
            {
                "label": "完整指南：通知通道配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#通知通道詳細配置",
            },
        ],

    ...
    def send_to_ntfy(
        ...
        *,
        ...
        try:
            ...
            logger.error("傳送 ntfy 訊息失敗: 請求超時")
            return False
        except requests.exceptions.RequestException as exc:
            logger.error("傳送 ntfy 訊息失敗: 網路請求異常")
            logger.debug("ntfy 請求異常型別: %s", type(exc).__name__)
            return False
        except Exception as exc:
            logger.error("傳送 ntfy 訊息失敗: 未知異常")
            logger.debug("ntfy 未知異常型別: %s", type(exc).__name__)
            return False

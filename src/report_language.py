...
SUPPORTED_REPORT_LANGUAGES = ("zh", "zh_TW", "en")
...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "強烈買進", "zh_TW": "強烈買進", "en": "Strong Buy"},
    "buy": {"zh": "買進", "zh_TW": "買進", "en": "Buy"},
    "hold": {"zh": "持有", "zh_TW": "持有", "en": "Hold"},
    "watch": {"zh": "觀望", "zh_TW": "觀望", "en": "Watch"},
    "reduce": {"zh": "減倉", "zh_TW": "減倉", "en": "Reduce"},
    "sell": {"zh": "賣出", "zh_TW": "賣出", "en": "Sell"},
    "strong_sell": {"zh": "強烈賣出", "zh_TW": "強烈賣出", "en": "Strong Sell"},
}
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "強烈看多", "zh_TW": "強烈看多", "en": "Strong Bullish"},
    "bullish": {"zh": "看多", "zh_TW": "看多", "en": "Bullish"},
    "sideways": {"zh": "震盪", "zh_TW": "震盪", "en": "Sideways"},
    "bearish": {"zh": "看空", "zh_TW": "看空", "en": "Bearish"},
    "strong_bearish": {"zh": "強烈看空", "zh_TW": "強烈看空", "en": "Strong Bearish"},
}
...
_CONFIDENCE_LEVEL_TRANSLATIONS = {
    "high": {"zh": "高", "zh_TW": "高", "en": "High"},
    "medium": {"zh": "中", "zh_TW": "中", "en": "Medium"},
    "low": {"zh": "低", "zh_TW": "低", "en": "Low"},
}
...
_CHIP_HEALTH_TRANSLATIONS = {
    "healthy": {"zh": "健康", "zh_TW": "健康", "en": "Healthy"},
    "average": {"zh": "一般", "zh_TW": "一般", "en": "Average"},
    "caution": {"zh": "警惕", "zh_TW": "警惕", "en": "Caution"},
}
...
_BIAS_STATUS_TRANSLATIONS = {
    "safe": {"zh": "安全", "zh_TW": "安全", "en": "Safe"},
    "caution": {"zh": "警戒", "zh_TW": "警戒", "en": "Caution"},
    "danger": {"zh": "危險", "zh_TW": "危險", "en": "Danger"},
}
...
_CHIP_UNAVAILABLE_BY_LANGUAGE = {
    "zh": "籌碼分佈未啟用或資料來源暫不可用，未納入籌碼判斷。",
    "zh_TW": "籌碼分佈未啟用或資料來源暫不可用，未納入籌碼判斷。",
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "valuation_fundamental_heading": "估值與基本面快照",
        "valuation_metrics_label": "估值指標",
        "fundamental_metrics_label": "基本面指標",
        "pe_ttm_label": "PE(TTM)",
        "pe_forward_label": "PE(預估)",
        "pb_label": "PB",
        "dividend_yield_label": "股息率",
        "market_cap_label": "市值",
        "revenue_yoy_label": "營收年增率",
        "earnings_yoy_label": "盈餘年增率",
        "net_profit_yoy_label": "淨利年增率",
        "roe_label": "ROE",
        "gross_margin_label": "毛利率",
        "snapshot_source_label": "資料來源",
        "snapshot_as_of_label": "資料日期",
        "snapshot_data_gap_label": "資料不足",
        "exposure_heading": "ETF／指數曝險摘要",
        "underlying_index_label": "追蹤標的",
        "leverage_factor_label": "槓桿倍數",
        "is_leveraged_label": "槓桿型",
        "is_inverse_label": "反向型",
        "market_risk_heading": "市場風險溫度計",
        "vix_level_label": "VIX指數",
        "vix_status_label": "VIX狀態",
        "spx_change_pct_label": "標普500漲跌幅",
        "multi_period_trend_heading": "多週期趨勢快照",
        "period_label": "週期",
        "change_pct_label": "漲跌幅",
        "drawdown_from_high_pct_label": "高點回撤",
        "price_vs_ma_pct_label": "均線位置",
        "trend_status_label": "狀態",
        "trend_status_uptrend_label": "上升",
        "trend_status_downtrend_label": "下降",
        "trend_status_neutral_label": "中性",
        "trend_status_insufficient_data_label": "資料不足",
        "battle_plan_heading": "作戰計劃",
        "ideal_buy_label": "理想買進點",
        "secondary_buy_label": "次優買進點",
        "stop_loss_label": "止損位",
    ...
    "en": {
        ...
        "valuation_fundamental_heading": "Valuation & Fundamental Snapshot",
        "valuation_metrics_label": "Valuation Metrics",
        "fundamental_metrics_label": "Fundamental Metrics",
        "pe_ttm_label": "PE (TTM)",
        "pe_forward_label": "PE (Forward)",
        "pb_label": "PB",
        "dividend_yield_label": "Dividend Yield",
        "market_cap_label": "Market Cap",
        "revenue_yoy_label": "Revenue YoY",
        "earnings_yoy_label": "Earnings YoY",
        "net_profit_yoy_label": "Net Profit YoY",
        "roe_label": "ROE",
        "gross_margin_label": "Gross Margin",
        "snapshot_source_label": "Source",
        "snapshot_as_of_label": "As Of",
        "snapshot_data_gap_label": "Insufficient Data",
        "exposure_heading": "ETF/Index Exposure Summary",
        "underlying_index_label": "Underlying Index",
        "leverage_factor_label": "Leverage Factor",
        "is_leveraged_label": "Leveraged",
        "is_inverse_label": "Inverse",
        "market_risk_heading": "Market Risk Thermometer",
        "vix_level_label": "VIX Level",
        "vix_status_label": "VIX Status",
        "spx_change_pct_label": "S&P 500 Change %",
        "multi_period_trend_heading": "Multi-period Trend Snapshot",
        "period_label": "Period",
        "change_pct_label": "Change %",
        "drawdown_from_high_pct_label": "Drawdown From High",
        "price_vs_ma_pct_label": "Price vs MA",
        "trend_status_label": "Status",
        "trend_status_uptrend_label": "Uptrend",
        "trend_status_downtrend_label": "Downtrend",
        "trend_status_neutral_label": "Neutral",
        "trend_status_insufficient_data_label": "Insufficient Data",
...
_REPORT_LABELS["zh_TW"] = {
    **_REPORT_LABELS["zh"],
    "dashboard_title": "決策儀錶板",
    "brief_title": "決策簡報",
    "analyzed_prefix": "共分析",
    "stock_unit": "檔股票",
    ...
    "phase_decision_heading": "盤中決策護欄",
    "action_window_label": "行動視窗",
    "immediate_action_label": "目前動作",
    "watch_conditions_label": "觀察條件",
    "next_check_time_label": "下次檢查",
    "confidence_reason_label": "信心理由",
    "data_limitations_label": "資料限制",
    "valuation_fundamental_heading": "估值與基本面快照",
    "valuation_metrics_label": "估值指標",
    "fundamental_metrics_label": "基本面指標",
    ...
    "report_date_label": "報告期",
    "revenue_label": "營業收入",
    "net_profit_label": "歸母淨利",
    "operating_cash_flow_label": "營業現金流",
    "revenue_yoy_label": "營收年增率",
    "net_profit_yoy_label": "淨利年增率",
    "gross_margin_label": "毛利率",
    "shareholder_return_heading": "股東回報",

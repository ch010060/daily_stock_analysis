...
class ReportMeta(BaseModel):
    ...
    stock_code: str = Field(..., description="股票代號")
    stock_name: Optional[str] = Field(None, description="股票名稱")
    market: Optional[str] = Field(None, description="TW/US market scope for external references")
    exchange: Optional[str] = Field(None, description="Canonical listing exchange when known")
    instrument_type: Optional[str] = Field(None, description="stock / etf / index / unknown")
    google_finance_exchange: Optional[str] = Field(None, description="Google Finance exchange code when resolvable")
    exchange_source: Optional[str] = Field(None, description="Source of exchange metadata")
    report_type: Optional[str] = Field(None, description="報告型別")
